...
// S = 0; B = 1; A = 2;
                        // S     B      A
const p_type A[3][3] = { {p_type(15.0 ), p_type(120.0), p_type(15.0 )},
                         {p_type(120.0), p_type(15.0 ), p_type(120.0)},
                         {p_type(15.0 ), p_type(120.0), p_type(15.0 )}}; // interaction matrix
...
int main() {
   ...
   for(int num_p=0; num_p <25; num_p++) {
       ...
       Particle<p_type>* p3 = new Particle<p_type>(p2->getPos().modulo_add(offset, unisize), 2, mass_p, conF, dragF, randF);
       Particle<p_type>* p4 = new Particle<p_type>(p3->getPos().modulo_add(offset, unisize), 2, mass_p, conF, dragF, randF);
